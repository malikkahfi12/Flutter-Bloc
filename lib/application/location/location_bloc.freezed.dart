...
class _$GetLocationCity
    with DiagnosticableTreeMixin
    implements GetLocationCity {
  _$GetLocationCity();
...
class _$GetLocationProvince
    with DiagnosticableTreeMixin
    implements GetLocationProvince {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'LocationEvent.getLocationProvince'));
  }
...
class _$_ProvinceDataOptions
    with DiagnosticableTreeMixin
    implements _ProvinceDataOptions {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'LocationState.provinceDataOptions'))
      ..add(DiagnosticsProperty('onLoading', onLoading))
      ..add(DiagnosticsProperty('dataProvince', dataProvince));
  }
